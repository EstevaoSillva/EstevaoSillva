...
## 💼 Sobre mim
- 🎓 Estagiário de Desenvolvimento de Software na **FPFTech**
- 📘 Cursando Análise e Desenvolvimento de Sistemas – **Faculdade Martha Falcão**
...
📫 **Contato:**  
[📧 Email](mailto:estevaovsilva@outlook.com) |  
[💬 WhatsApp](https://wa.me/5592988049143) |  
[🔗 LinkedIn](https://www.linkedin.com/in/estevaovsilva)
...
![Trino](https://img.shields.io/badge/Trino-0A2043?style=for-the-badge)
...
- Construção de **Data Lake em MinIO** seguindo arquitetura medalhão (Bronze, Silver e Gold)
...
- Implementação de **RAG** para análise e consulta semântica de documentos
- Backend com **Django REST**, PostgreSQL, Celery, Redis e Docker
- CI/CD com GitLab e atuação em times ágeis (Kanban)
...
- Estudos em **LLMs, RAG, coordenação de agentes e Data Engineering**
- Ambientes Docker e pipelines CI/CD

---

## 📚 Formação Acadêmica
🎓 **Formação Full Stack em Inteligência Artificial** – FPFTech / NCIA *(2025–2026)*  
🎓 **Tecnólogo em Análise e Desenvolvimento de Sistemas** – Faculdade Martha Falcão *(2024–2026)*  
🎓 **Técnico em Desenvolvimento de Software** – FPFTech *(2024–2025)*  
...
📌 Sempre buscando desafios em **Engenharia de Dados, Backend Python e Inteligência Artificial**  
☕ Bora conversar sobre **agentes, dados, LLMs ou arquitetura de sistemas**?
